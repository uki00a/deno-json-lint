 ...
 * * https://raw.githubusercontent.com/denoland/deno/085be0b5ff8ca3ccfe58318afe0939c4d4af9743/cli/schemas/config-file.v1.json
 * * https://raw.githubusercontent.com/denoland/deno/085be0b5ff8ca3ccfe58318afe0939c4d4af9743/cli/schemas/lint-tags.v1.json
 * * https://raw.githubusercontent.com/denoland/deno/085be0b5ff8ca3ccfe58318afe0939c4d4af9743/cli/schemas/lint-rules.v1.json
 */
...
export type AllowDenyIgnorePermissionConfigValue = PermissionConfigValue | AllowDenyIgnorePermissionConfig;
...
export interface DenoConfigurationFileSchema {
  ...
  importMap?: string;
  /**
   * A map of package names to version requirements for the default catalog, used with the catalog: protocol in workspace member package.json files.
   */
  catalog?: {
    /**
     * The key is the npm package name, with a value that is the version requirement string.
     */
    [k: string]: string;
  };
  /**
   * Named catalogs mapping catalog names to package name/version requirement mappings, used with the catalog:<name> protocol.
   */
  catalogs?: {
    [k: string]: {
      [k: string]: string;
  ...
  fmt?: {
     ...
     */
    vueComponentCase?: "ignore" | "pascal-case" | "kebab-case";
    /**
  ...
  test?: {
    ...
    permissions?: PermissionNameOrSet;
    /**
     * Enable the ops sanitizer for all tests. Ensures that all async ops started in a test are completed before the test ends. Can be overridden per-test or per-module.
     */
    sanitizeOps?: boolean;
    /**
     * Enable the resources sanitizer for all tests. Ensures that all resources opened in a test are closed before the test ends. Can be overridden per-test or per-module.
     */
